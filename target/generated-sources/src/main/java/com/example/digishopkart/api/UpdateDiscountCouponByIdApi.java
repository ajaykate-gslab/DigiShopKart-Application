...
@Validated
public interface UpdateDiscountCouponByIdApi {

    @Operation(summary = "", description = "Api to update Discount Coupons recors", tags={  })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/updateDiscountCouponById",
        produces = { "application/json" }, 
        consumes = { "application/json" }, 
        method = RequestMethod.PATCH)
    ResponseEntity<Discount> updateDiscountCouponByIdPatch(@NotNull @Parameter(in = ParameterIn.QUERY, description = "" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "id", required = true) Integer id, @Parameter(in = ParameterIn.DEFAULT, description = "A JSON object Contenting Discount information.", required=true, schema=@Schema()) @Valid @RequestBody Discount body);
