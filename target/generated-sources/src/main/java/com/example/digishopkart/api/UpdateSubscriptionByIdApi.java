...
@Validated
public interface UpdateSubscriptionByIdApi {

    @Operation(summary = "", description = "Api to update subscription record by id", tags={  })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/updateSubscriptionById",
        produces = { "application/json" }, 
        consumes = { "application/json" }, 
        method = RequestMethod.PATCH)
    ResponseEntity<Subacription> updateSubscriptionByIdPatch(@NotNull @Parameter(in = ParameterIn.QUERY, description = "" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "id", required = true) Integer id, @Parameter(in = ParameterIn.DEFAULT, description = "A JSON object Contenting Subacription information.", required=true, schema=@Schema()) @Valid @RequestBody Subacription body);
