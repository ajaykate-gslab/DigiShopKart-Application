...
@Validated
public interface DeleteCustomerByIdApi {

    @Operation(summary = "", description = "api to delete the customer", tags={  })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Customer> deleteCustomerByIdDelete(@NotNull @Parameter(in = ParameterIn.QUERY, description = "" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "id", required = true) Integer id);
