...
@Validated
public interface FetchOrderByIdApi {

    @Operation(summary = "", description = "Api to fetch Order by id", tags={  })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/fetchOrderById",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Order> fetchOrderByIdGet(@NotNull @Parameter(in = ParameterIn.QUERY, description = "" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "id", required = true) Integer id);
