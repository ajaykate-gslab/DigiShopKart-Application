...
public interface DeleteSubscriptionByIdApi {
    ...
    ResponseEntity<Subscription> deleteSubscriptionByIdDelete(@NotNull @Parameter(in = ParameterIn.QUERY, description = "" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "id", required = true) Integer id);
