...
@Validated
public interface FetchAllDiscountCouponsApi {

    @Operation(summary = "", description = "Api to fetch All the Discount coupons", tags={  })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/fetchAllDiscountCoupons",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<Discount>> fetchAllDiscountCouponsGet();
