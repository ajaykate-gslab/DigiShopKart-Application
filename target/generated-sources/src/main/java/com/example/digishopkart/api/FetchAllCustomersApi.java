...
@Validated
public interface FetchAllCustomersApi {

    @Operation(summary = "", description = "all customer", tags={  })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/fetchAllCustomers",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<Customer>> fetchAllCustomersGet();
