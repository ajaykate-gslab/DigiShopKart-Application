...
@Validated
public interface FetchAllSubscriptionsApi {

    @Operation(summary = "", description = "APi to get All the sunscriptions", tags={  })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/fetchAllSubscriptions",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<Subacription> fetchAllSubscriptionsGet();
