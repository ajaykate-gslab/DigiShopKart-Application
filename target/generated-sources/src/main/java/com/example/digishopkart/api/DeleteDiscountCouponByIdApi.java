...
@Validated
public interface DeleteDiscountCouponByIdApi {

    @Operation(summary = "", description = "Api to delete Discount Coupon By id", tags={  })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/deleteDiscountCouponById",
        produces = { "application/json" }, 
        method = RequestMethod.DELETE)
    ResponseEntity<Discount> deleteDiscountCouponByIdDelete(@NotNull @Parameter(in = ParameterIn.QUERY, description = "" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "id", required = true) Integer id);
