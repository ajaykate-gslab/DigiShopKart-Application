...
public interface CreateOrderApi {
    ...
    @Operation(summary = "", description = "Api to create Order by using Customer, Product and Discount", tags={  })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Order> createOrderPost(@Parameter(in = ParameterIn.DEFAULT, description = "A JSON object Contenting Order information", required=true, schema=@Schema()) @Valid @RequestBody Order body);
