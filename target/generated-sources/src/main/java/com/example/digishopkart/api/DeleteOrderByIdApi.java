...
@Validated
public interface DeleteOrderByIdApi {

    @Operation(summary = "", description = "Api to delete the Order by id", tags={  })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Order> deleteOrderByIdDelete(@NotNull @Parameter(in = ParameterIn.QUERY, description = "" ,required=true,schema=@Schema()) @Valid @RequestParam(value = "id", required = true) Integer id);
